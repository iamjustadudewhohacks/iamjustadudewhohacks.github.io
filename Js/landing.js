...
let listOfFiles = {
	...
	'About_Me.txt': () => {
		historyCommands += "Hi I'm Abhishek Dhakal, a part time ethical hacker.<br><br>";
	},
	'Contact_Me.txt': () => {
		historyCommands +=
		"HackerOne: <a href = 'https://hackerone.com/m4gn3tb0ssz?type=user' target='_blank'>Abhishek Dhakal</a><br>Facebook: 	<a href = 'https://facebook.com/Dhakal.Avisek' target='_blank'> Abhishek </a><br>BugCrowd: 	<a href = 'https://bugcrowd.com/AbhishekDhakalb7fd89f7-0315-412c-995e-8ab306e704f3' target='_blank'>Abhishek</a><br><br>";
	},
	'Github.txt': () => {
		historyCommands +=
			"GitHub: <a href = 'https://github.com/its-m4gn3t' target='_blank'>Abhishek Dhakal</a><br><br>";
	},
	'Linkedin.txt': () => {
		historyCommands +=
			"Linkedin: <a href = 'https://www.linkedin.com/in/abhishekdhakal' target='_blank'>Abhishek Dhakal</a><br><br>";
	},
	'Credits.txt': () => {
		historyCommands +=
			"Complete credit goes to Abhishek Dhakal. <br><br>";
	},
};
...
let historyCommands =
	"Hello There, <br>You can use the command line to interact, start out by typing 'help'<br>Or you can use the folder view";
let clText = '<span id = "path">MagnetOs@user:~$</span>'; //this should be changed
...
const commandFunction = (c) => {
	...
	if (c == 'fork') {
		historyCommands +=
			"You can fork this website <br><a href ='#' target='_blank'>here</a>";
	}
